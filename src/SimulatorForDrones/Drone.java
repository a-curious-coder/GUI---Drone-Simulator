...
public class Drone extends Circle   { // Drone extends circle attributes - represented by circle.
     ...
     *
     * @param drone drone object - modify the attributes in the function
     ...
     *
     * @param drone drone object - modify the attributes in the function
     * @return  perceived center vector
     */
    ...
    public static Point avoidance (Drone drone)  {
        ...
        for (Circle obstacle : Obstacles) {
            ...
            if (distance < drone.getObstacleAvoidanceRadius()) {
                ...
                Point collision = new Point(drone.getVelocity()).normalize().multiply(distance);
                if (collision.add(drone.getLocation()).distanceTo(obstaclePosition) <= obstacle.getRadius() + drone.getRadius()) {

                    if (distance < closestObstacleDistance) {

                        closestObstacleDistance = distance;
                        avoidance = new Point(collision);
    ...
    /**
     * This function has been replaced by 'edges' function
     *
     * @param drone drone object - modify the attributes in the function
     * @return  new location vector to ensure drones dont go outside of bounds
     */
     ...
     *
     * @return vector of random location created
     */
    ...
    /**
     * Got ambitious and created a functions that generates a random colour.
    ...
    /**
     * This sets boundary constraints for the drones to move within when the animation is occurring.
     * @param drone drone object - modify the attributes in the function
     */
     ...
     * @return  if distance to flock is less than droneFlock radius
     */
    ...
    /**
     * sets location to value of parameter
     * @param location location to use when setting this.location value
     */
    ...
    /**
     * sets the velocity using value of parameter
     * @param velocity value to use in order to set this.velocity value
     *
     */
    ...
    /**
     *  The determines the distance between drones when separated.
    ...
    /**
     * The determines the distance between drone objects and the obstacle object for the avoidance function
    ...
    /**
     * Sets the maxSpeed to the value of the parameter passed in
     * @param maxSpeed this is the parameter used to set this.maxSpeed
     */
    ...
    /**
     *  The purpose of this function is to calculate a desired vector for steering a drone toward another drone/group.
     * @param target the target who's location we want to move toward
     * @return desired steer vector
     */
